	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#collapse" aria-expanded="false">					<span class="sr-only">navigation</span>
						...
						<div id="gets_product">
							...
							<table class="table table-hover">
								...
								<tbody >
									<tr>
										<td>producto</td>
										<td><img src="product_images/1.0x0.jpg"  alt="{{$libro->titulo}}" class="img-responsive" width="100" height="100" /></td>
										<td>titulo</td>
										<td>resumen</td>    
										<td>categoria</td>
										<td>ejemplares</td>
